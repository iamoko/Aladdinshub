 <?php include('includes/header.php') ?>  
            ...
            <div class="row" style="color: #000">
              ...
              <div class="col-md-12" >
                <div class="white-box">
                    <h2 class="header-title" style="font-weight: bold;border: 1px solid;height: 50px;padding-top:16px;padding-left: 20px;background:#2c3b48e3;color: #fff ">Site Details</h2>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <button type="submit" class="btn btn-inverse" style="background: #2c3b48e3">Submit</button>
