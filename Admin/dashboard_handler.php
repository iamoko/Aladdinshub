            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href="#"><i class="icon-people"></i> <span>Users and Customers</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="dashboard/menu/1"> Users</a></li>
                        <li><a href="dashboard/menu/2"> Customers</a></li>
                        <li><a href="dashboard/menu/3"> Per day User</a></li>
                        <li><a href="dashboard/menu/4"> Staff User</a></li>
                    </ul>
                </li>
                
                <li class="menu-list"><a href="#"><i class="icon-grid"></i> <span>Category</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="dashboard/menu/5"> Suppliers & Products</a></li>
                        <li><a href="dashboard/menu/6"> Classified</a></li>
                        <li><a href="dashboard/menu/7"> Trade Lead</a></li>
                    </ul>
                </li>

                <li class="menu-list"><a href="#"><i class="icon-basket-loaded"></i> <span>Products</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="dashboard/menu/8"> Products</a></li>
                        <li><a href="dashboard/menu/9"> Classified Products</a></li>
                    </ul>
                </li>

                <li class="menu-list"><a href="#"><i class="icon-docs"></i> <span>Trade Lead Management</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="dashboard/menu/10"> Sell List</a></li>
                        <li><a href="dashboard/menu/11"> Buy List</a></li>
                    </ul>
                </li>
                
                
                <li><a href="dashboard/menu/12"><i class="icon-tag"></i> <span>Ads & Banners</span></a> </li>

                <li class="menu-list"><a href="#"><i class="icon-note"></i> <span>Approval Center</span></a>
                    <ul class="sub-menu-list">
                    <li><a href="dashboard/menu/13"> Product Approval</a></li>
                    <li><a href="dashboard/menu/14"> Trade Buy</a></li>
                    <li><a href="dashboard/menu/15"> Trade Sell</a></li>
                    <li><a href="dashboard/menu/16"> Customer</a></li>
                    </ul>
                </li>
                
                
                <li><a href="dashboard/menu/17"><i class="icon-credit-card"></i> <span>Buy Requirement</span></a></li>
                <li><a href="dashboard/menu/18"><i class="ti-stamp"></i> <span>SEO</span></a></li>

                <li class="menu-list"><a href="#"><i class="icon-phone"></i> <span>Inquiry Box</span></a>
                    <ul class="sub-menu-list">
                    <li><a href="dashboard/menu/19"> Inquiry Box</a></li>
                    <li><a href="dashboard/menu/20"> Admin Inquiry Box</a></li>
                    </ul>
                </li>
                <li><a href="dashboard/menu/21"><i class="icon-location-pin"></i> <span>Location Management</span></a></li>


               

                <li><a href="dashboard/menu/25"><i class="fa fa-usd"></i> <span>Currency Management</span></a></li>
                <li><a href="dashboard/menu/26"><i class="fa fa-envelope-o"></i> <span>Email Template</span></a></li>


                <li class="menu-list"><a href="#"><i class="fa fa-wrench"></i> <span>Settings</span></a>
                    <ul class="sub-menu-list">
                    <li><a href="dashboard/menu/27"> Site Details</a></li>
                    <li><a href="dashboard/menu/28"> Payment Option</a></li>
                    <li><a href="dashboard/menu/29"> Social Link Setting</a></li>
                    <li><a href="dashboard/menu/30"> SMTP Mail Configuration</a></li>
                    <li><a href="dashboard/menu/32"> Site Status</a></li>
                    <li><a href="dashboard/menu/33"> Logo Change Details</a></li>
                    <li><a href="dashboard/menu/34"> Member Package</a></li>
                    </ul>
                </li>
                
                <li class="menu-list"><a href="#"><i class="ti-layout-grid3"></i> <span>Home Page Management</span></a>
                    <ul class="sub-menu-list">
                    <li><a href="dashboard/menu/35"> Home Page Banner</a></li>
                    <li><a href="dashboard/menu/36"> Sliding Images</a></li>
                    <li><a href="dashboard/menu/37"> RFQ & Featured Brands Panel</a></li>
                    </ul>
                </li>
